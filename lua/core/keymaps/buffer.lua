...
vim.keymap.set('n', '<leader>xs', ':<C-u>buffer ', { noremap = true, silent = true, desc = 'Switch to buffer by number' })
...
vim.keymap.set('n', '<leader>xR', ':checktime<CR>', { noremap = true, silent = true, desc = 'Check for external changes' })
...
vim.keymap.set('n', '<leader>xvv', ':vertical sbuffer ', { noremap = true, silent = true, desc = 'Buffer in vertical split' })
...
-- Show buffer info
vim.keymap.set('n', '<leader>xi', ':echo bufname("%")<CR>', { noremap = true, silent = true, desc = 'Show buffer name' })
vim.keymap.set('n', '<leader>xI', ':echo bufnr("%")<CR>', { noremap = true, silent = true, desc = 'Show buffer number' })

-- Buffer diagnostics
vim.keymap.set('n', '<leader>xd', ':lua vim.diagnostic.open_float()<CR>', { noremap = true, silent = true, desc = 'Buffer diagnostics' })
